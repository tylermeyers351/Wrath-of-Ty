...
Shader "Polytope Studio/PT_Vegetation_Foliage_Shader_NR"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float clampResult738 = clamp( pow( ( (0.5 + (IN.ase_texcoord8.y - 0.0) * (2.0 - 0.5) / (1.0 - 0.0)) * _Gradient ) , _GradientPower ) , -1.0 , 1.0 );
...
Node;AmplifyShaderEditor.RangedFloatNode;742;1752.503,387.9955;Inherit;False;Property;_Smoothness;Smoothness;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D2C97E9F2236EB5E7E6688A23530B6B7CD27CA2C